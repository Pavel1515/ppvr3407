...
<meta name="description" content="Создаю сайты на WordPress, Elementor и с помощью ИИ более 5 лет. Быстро, красиво, с гарантией результата.">
...
<section class="hero">
  ...
  <p>Веб-разработчик с опытом 5+ лет. Совмещаю WordPress, Elementor и искусственный интеллект, чтобы делать сайты быстрее, дешевле и без потери качества.</p>
  <div class="hero-cta">
...
<section id="services">
  ...
  <div class="services-grid">
    ...
    <div class="service-card reveal">
      ...
      <p>Использую нейросети для текстов, изображений и ускорения разработки — быстрее в 2-3 раза без потери качества.</p>
    </div>
    <div class="service-card reveal">
      <div class="service-icon">🛒</div>
...
<section id="about">
  <div class="about-grid">
    ...
    <div class="about-text reveal">
      ...
      <p>Более 5 лет делаю сайты для малого и среднего бизнеса: от лендингов до интернет-магазинов. Специализируюсь на WordPress и Elementor — это даёт клиентам гибкость управлять сайтом самостоятельно после сдачи проекта.</p>
      <p>Активно использую ИИ-инструменты на всех этапах — от генерации текстов и изображений до ускорения рутинной разработки. Это позволяет делать сайты быстрее без потери качества и держать цены разумными.</p>
...
<section id="portfolio">
  ...
  <div class="portfolio-grid">
    ...
    <a href="project.php?slug=<?= esc($project['slug'] ?? '') ?>" class="portfolio-card reveal">
      ...
      <div class="portfolio-overlay"><span><?= esc($project['category'] ?? '') ?></span><h3><?= esc($project['title'] ?? '') ?></h3></div>
    </a>
    <?php endforeach; ?>
...
<section>
  ...
  <div class="test-grid">
    <div class="test-card reveal">
      ...
      <div class="test-author"><div class="avatar">М</div><div><b>Марина К.</b><span>владелица студии интерьера</span></div></div>
    </div>
    <div class="test-card reveal">
      <div class="stars">★★★★★</div>
      <p>«Наконец разработчик, который объясняет всё простым языком и не пропадает после оплаты. Рекомендую».</p>
      <div class="test-author"><div class="avatar">Д</div><div><b>Дмитрий С.</b><span>основатель Fitlab</span></div></div>
    </div>
    <div class="test-card reveal">
      <div class="stars">★★★★★</div>
      <p>«Перенесли магазин на WooCommerce без единого дня простоя. Конверсия выросла на 30%».</p>
      <div class="test-author"><div class="avatar">Е</div><div><b>Елена В.</b><span>Bloom маркетплейс</span></div></div>
    </div>
  </div>
</section>
...
<section id="faq">
  ...
  <div class="faq">
    <div class="faq-item reveal">
      ...
      <div class="faq-a">В среднем от 5 до 21 дня в зависимости от сложности проекта. Точные сроки фиксируем в ТЗ до старта работ.</div>
    </div>
    <div class="faq-item reveal">
      <div class="faq-q"><span>Вы делаете дизайн сами или нужен дизайнер?</span><span class="plus">+</span></div>
      <div class="faq-a">Могу собрать дизайн сам на основе референсов и с помощью ИИ-инструментов, либо работать по готовому макету из Figma.</div>
    </div>
    <div class="faq-item reveal">
      <div class="faq-q"><span>Что будет после сдачи сайта?</span><span class="plus">+</span></div>
      <div class="faq-a">Обучаю вас редактировать сайт самостоятельно и предлагаю пакеты поддержки на выбор — от разовых правок до полного сопровождения.</div>
    </div>
    <div class="faq-item reveal">
      <div class="faq-q"><span>Работаете ли вы с оплатой поэтапно?</span><span class="plus">+</span></div>
      <div class="faq-a">Да, стандартно 50% предоплата на старте и 50% после сдачи проекта. Для крупных проектов возможна разбивка на этапы.</div>
    </div>
  </div>
</section>
...
<section id="contact">
  ...
  <div class="contact-wrap reveal">
    <form class="contact-form" action="contact.php" method="POST">
      <div class="form-error" id="formError">Пожалуйста, заполните имя, email и сообщение корректно и попробуйте снова.</div>
      <div class="form-row">
      ...
      <div class="form-group">
        ...
        <textarea id="f-message" name="message" rows="5" required placeholder="Расскажите коротко о проекте"></textarea>
      </div>
    ...
    <div class="contact-side">
      <div class="contact-card"><span>Email</span><a href="mailto:hello@ranked.net.au">hello@ranked.net.au</a></div>
      <div class="contact-card"><span>Telegram</span><a href="#">@paveldev</a></div>
