...
if(burger && navLinks){
  burger.addEventListener('click', ()=>{
    ...
    navLinks.style.cssText += isOpen ? '' : 'position:absolute; top:64px; left:0; right:0; background:#0b0c10; flex-direction:column; padding:24px; gap:18px; border-bottom:1px solid #23262f;';
  });
}
